...
module.exports = {
	...
	async execute(variables) {
        ...
        if (user.Donator != `y` && user.Donator != `fs`) return await interaction.reply(`\`/weekly\` is only available to donators. To become a donator, use \`/donate\` and if you are indeed a donator, contact chig#4519 to sort this out.`);
